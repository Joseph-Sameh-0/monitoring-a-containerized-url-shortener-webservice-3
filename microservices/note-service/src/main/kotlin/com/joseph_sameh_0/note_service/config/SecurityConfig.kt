package com.joseph_sameh_0.note_service.config

import com.joseph_sameh_0.note_service.security.JwtAuthenticationFilter
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .authorizeHttpRequests { auth ->
                auth
                    .requestMatchers("/n/{shortCode}").permitAll()
